...
extern PROTOBUF_INTERNAL_EXPORT_process_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Process_process_2eproto;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_monitor_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::monitor::proto::MonitorInfo, process_),
};
...
const char descriptor_table_protodef_monitor_5finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ftirq.proto\032\016cpu_load.proto\032\rprocess.pro"
  "to\"\226\002\n\013MonitorInfo\022\014\n\004name\030\001 \001(\t\022(\n\010soft"
  "_irq\030\004 \003(\0132\026.monitor.proto.SoftIrq\022(\n\010cp"
  "u_load\030\005 \001(\0132\026.monitor.proto.CpuLoad\022(\n\010"
  "cpu_stat\030\006 \003(\0132\026.monitor.proto.CpuStat\022("
  "\n\010mem_info\030\007 \001(\0132\026.monitor.proto.MemInfo"
  "\022(\n\010net_info\030\010 \003(\0132\026.monitor.proto.NetIn"
  "fo\022\'\n\007process\030\t \001(\0132\026.monitor.proto.Proc"
  "ess2\235\001\n\013GrpcManager\022F\n\016SetMonitorInfo\022\032."
  "monitor.proto.MonitorInfo\032\026.google.proto"
  "buf.Empty\"\000\022F\n\016GetMonitorInfo\022\026.google.p"
  "rotobuf.Empty\032\032.monitor.proto.MonitorInf"
  "o\"\000b\006proto3"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_monitor_5finfo_2eproto_deps[7] = {
  ...
  &::descriptor_table_process_2eproto,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_monitor_5finfo_2eproto = {
  false, false, descriptor_table_protodef_monitor_5finfo_2eproto, "monitor_info.proto", 611,
...
class MonitorInfo::_Internal {
 public:
  ...
  static const ::monitor::proto::Process& process(const MonitorInfo* msg);
};
...
const ::monitor::proto::Process&
MonitorInfo::_Internal::process(const MonitorInfo* msg) {
  return *msg->process_;
}
...
void MonitorInfo::clear_process() {
...
MonitorInfo::MonitorInfo(const MonitorInfo& from)
  ...
  if (from._internal_has_process()) {
    process_ = new ::monitor::proto::Process(*from.process_);
  } else {
    process_ = nullptr;
  }
...
void MonitorInfo::SharedCtor() {
  ...
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&cpu_load_)) + sizeof(process_));
}
...
::PROTOBUF_NAMESPACE_ID::uint8* MonitorInfo::_InternalSerialize(
  ...
  if (this->has_process()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        9, _Internal::process(this), target, stream);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:monitor.proto.MonitorInfo)
  ...
  if (from.has_process()) {
    _internal_mutable_process()->::monitor::proto::Process::MergeFrom(from._internal_process());
  }
}
...
void MonitorInfo::InternalSwap(MonitorInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MonitorInfo, process_)
      + sizeof(MonitorInfo::process_)
