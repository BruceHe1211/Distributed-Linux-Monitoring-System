...
class MonitorInfo PROTOBUF_FINAL :
 ...
 public:
  ...
  // .monitor.proto.Process process = 9;
  bool has_process() const;
  private:
  bool _internal_has_process() const;
  public:
  void clear_process();
  const ::monitor::proto::Process& process() const;
  ::monitor::proto::Process* release_process();
  ::monitor::proto::Process* mutable_process();
  void set_allocated_process(::monitor::proto::Process* process);
  private:
  const ::monitor::proto::Process& _internal_process() const;
  ::monitor::proto::Process* _internal_mutable_process();
  public:
  void unsafe_arena_set_allocated_process(
      ::monitor::proto::Process* process);
  ::monitor::proto::Process* unsafe_arena_release_process();
 ...
 private:
  ...
  ::monitor::proto::Process* process_;
...
// .monitor.proto.Process process = 9;
inline bool MonitorInfo::_internal_has_process() const {
  return this != internal_default_instance() && process_ != nullptr;
}
inline bool MonitorInfo::has_process() const {
  return _internal_has_process();
}
inline const ::monitor::proto::Process& MonitorInfo::_internal_process() const {
  const ::monitor::proto::Process* p = process_;
  return p != nullptr ? *p : reinterpret_cast<const ::monitor::proto::Process&>(
      ::monitor::proto::_Process_default_instance_);
}
inline const ::monitor::proto::Process& MonitorInfo::process() const {
  // @@protoc_insertion_point(field_get:monitor.proto.MonitorInfo.process)
  return _internal_process();
}
inline void MonitorInfo::unsafe_arena_set_allocated_process(
    ::monitor::proto::Process* process) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:monitor.proto.MonitorInfo.process)
}
inline ::monitor::proto::Process* MonitorInfo::release_process() {
  
  ::monitor::proto::Process* temp = process_;
  process_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::monitor::proto::Process* MonitorInfo::unsafe_arena_release_process() {
  // @@protoc_insertion_point(field_release:monitor.proto.MonitorInfo.process)
  
  ::monitor::proto::Process* temp = process_;
  process_ = nullptr;
  return temp;
}
inline ::monitor::proto::Process* MonitorInfo::_internal_mutable_process() {
  
  if (process_ == nullptr) {
    auto* p = CreateMaybeMessage<::monitor::proto::Process>(GetArena());
    process_ = p;
  }
  return process_;
}
inline ::monitor::proto::Process* MonitorInfo::mutable_process() {
  // @@protoc_insertion_point(field_mutable:monitor.proto.MonitorInfo.process)
  return _internal_mutable_process();
}
inline void MonitorInfo::set_allocated_process(::monitor::proto::Process* process) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(process_);
  }
  ...
  process_ = process;
  // @@protoc_insertion_point(field_set_allocated:monitor.proto.MonitorInfo.process)
}
