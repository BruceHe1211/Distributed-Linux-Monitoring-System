...
class MonitorWidget : public QWidget {
 ...
 public:
  ...
  QWidget* InitProcessMonitorWidget(); // 新增方法
 ...
 private:
  ...
  QTableView* process_monitor_view_ = nullptr; // 新增成员变量
  ...
  ProcessModel* process_model_ = nullptr; // 新增成员变量
